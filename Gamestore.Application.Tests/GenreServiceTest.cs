...
namespace Gamestore.Application.Tests
{
    public class GenreServiceTest
    {
        ...
        private GenreService CreateService() => new(
        ...
        public async Task CreateGenreAsync_HappyCreating_GenerateNewGenreEntity()
        {
            ...
            _mockGenreRepo.Verify(
                r => r.CreateGenreAsync(It.IsAny<Genre>()),
                Times.Once
            );
        ...
        public async Task GetAllGenresAsync_WhenGenresExists_ReturnGenreDTOs()
        {
            ...
            _mockGenreRepo.Setup(r => r.GetAllGenresAsync()).ReturnsAsync(new List<Genre>
            {
                genre1,
                genre2
            });
        ...
        public async Task GetGenreseByGameKeyAsync_GenresFound_ReturnGenresDTOsCollection()
        {
            ...
            _mockGenreRepo.Setup(r => r.GetGenresByGameKeyAsync(genreKey)).ReturnsAsync(new List<Genre>
            {
                genre1,
                genre2
            });
        ...
        public async Task GetGenreByIdAsync_GenreFound_ReturnGenresCollection()
        {
            ...
            _mockMapper.Setup(_mockMapper => _mockMapper.Map<GenreFullDto>(genre)).Returns(genreDto);
        ...
        public async Task GetGenresByParentIdAsync_GenresFound_ReturnGenresDTOsCollection()
        {
            ...
            _mockGenreRepo.Setup(r => r.GetGenresByParentIdAsync(parentGenreId)).ReturnsAsync(new List<Genre>
            {
                genre1,
                genre2
            });
