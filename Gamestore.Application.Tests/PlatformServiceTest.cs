...
namespace Gamestore.Application.Tests
{
    public class PlatformServiceTest
    {
        ...
        private static PlatformDto CreatePlatformDto(Platform platform)
            => new()
            {
                Type = platform.Type,
            };
        ...
        public async Task GetAllPlatformsAsync_WhenPlatformExists_ReturnPlatformDTOs()
        {
            ...
            _mockPlatformRepo.Setup(r => r.GetAllPlatformsAsync()).ReturnsAsync(new List<Platform>
            {
                platform1,
                platform2
            });
        ...
        public async Task GetPlatformByGameKeyAsync_PlatformFound_ReturnPlatformDTOsCollection()
        {
            ...
            _mockPlatformRepo.Setup(r => r.GetPlatformsByGameKeyAsync(genreKey)).ReturnsAsync(new List<Platform>
            {
                platform1,
                platform2
            });
        ...
        public async Task GetPlatformByIdAsync_PlatformFound_ReturnPlatformsCollection()
        {
            ...
            _mockMapper.Setup(_mockMapper => _mockMapper.Map<PlatformFullDto>(genre)).Returns(platformDto);
